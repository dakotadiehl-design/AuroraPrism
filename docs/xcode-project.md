...
`AuroraUI`, `AuroraCore`, `AuroraModel`, `AuroraFixtureLib`, `AuroraEngine`, `AuroraOutput`, `AuroraMIDI`, and `AuroraDiagnostics`. Remote networking is temporarily unavailable; no remote protocol package is linked.
